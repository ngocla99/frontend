-- Migration: Celebrity Advanced Matching Algorithm
-- Created: 2025-11-06
-- Description: Implements advanced 6-factor matching algorithm for celebrity matches, reusing calculate_advanced_similarity function

-- Advanced celebrity matching function with 6-factor scoring
...
COMMENT ON FUNCTION find_celebrity_matches_advanced IS 'Find celebrity matches using advanced 6-factor matching algorithm with quality gate (0.6+) and opposite gender filtering. Reuses calculate_advanced_similarity() from migration 019.';
