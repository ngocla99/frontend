...
export const PotentialMatches = ({ userGender, onSelectMatch, selectedMatch }: PotentialMatchesProps) => {
  ...
  const potentialMatches: PotentialMatch[] = [
    {
      ...
      image: userGender === 'male' ? "https://images.unsplash.com/photo-1494790108755-2616b612b647?w=400&h=400&fit=crop&crop=face" : "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face",
      age: 22,
    ...
    },
    {
      ...
      image: userGender === 'male' ? "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop&crop=face" : "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face",
      age: 21,
      university: "Stanford University", 
      major: "Psychology",
    ...
    },
    {
      ...
      image: userGender === 'male' ? "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&h=400&fit=crop&crop=face" : "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop&crop=face",
      age: 23,
      university: "Stanford University",
      major: "Biology", 
    ...
    },
    {
      ...
      image: userGender === 'male' ? "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop&crop=face" : "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=400&h=400&fit=crop&crop=face",
      age: 20,
      university: "Stanford University",
      major: "Business",
  ...
  return (
    <Card className="p-4 sm:p-6 bg-gradient-card shadow-soft border-0 hover:shadow-match transition-all duration-300">
      <div className="text-center mb-4 sm:mb-6">
        ...
        <h2 className="text-xl sm:text-2xl font-display font-bold text-foreground mb-2">Your Potential Matches</h2>
        <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">Click on someone to see your baby together!</p>
      </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1 sm:mb-2">
                    <h3 className="font-bold text-foreground text-sm sm:text-base truncate">{match.name}, {match.age}</h3>
      ...
      <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-blue-50 rounded-lg border border-blue-200">
        <p className="text-xs sm:text-sm text-blue-700 text-center leading-relaxed">
          💡 All matches are from your university. Click any profile to generate your future baby!
        </p>
      </div>
    </Card>
  );
